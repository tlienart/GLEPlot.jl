...
"""
set_dist!(o, v::F64)           = (o.dist = v;)
set_dist!(o::Ticks, v::F64)    = set_dist!(o.labels, v)
set_dist!(o::Colorbar, v::F64) = set_dist!(o.ticks, v)
...
"""
set_length!(o::Ticks, v::F64)    = (o.length = v;)
set_length!(o::Colorbar, v::F64) = set_length!(o.ticks, v)
...
"""
set_angle!(o::Ticks, v::F64)    = (o.labels.angle = v;)
set_angle!(o::Colorbar, v::F64) = throw(NotImplementedError("set_angle! for Colorbar"))
...
"""
set_shift!(o::Ticks, v::F64)    = (o.labels.shift = v;)
set_shift!(o::Colorbar, v::F64) = set_shift!(o.ticks, v)
