# XXX this is used by the colorbar.
# this relies on `.r, .g, .b` --> have to parse this, see `alpha(...)`
# potentially have a primary function which recovers rgba from string
# then make alpha retrieve the alpha field etc.
#
